...
pub const CAPABILITIES: &[Capability] = &[
    ...
    Capability {
        ...
        tests: "",
        status: Status::Absent,
        residual_gap: "Not implemented; identity correlation is the prerequisite and now exists",
    },
    Capability {
        ...
        status: Status::Partial,
        residual_gap: "No cross-session history yet; U/L-bit address-type approximation; app does not yet visually merge rows",
    },
    Capability {
