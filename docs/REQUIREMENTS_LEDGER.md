...
**Runtime verification evidence:** `cargo test -p bleradar-core --locked --test core --test properties` and `cargo test -p bleradar-jni --locked --test jni_bridge` (2026-09-09, this session). Doctests and workspace integration are covered by `cargo xtask gates`.
