...
public final class ManifestSourceSmoke {
    ...
    private static final String MANIFEST = "version_code = 2\nversion_name = 1.0.1\n"
            + "url = https://example.com/HSE-BLE-Radar-arm64-v1.0.1.apk\nsize_bytes = 406094\n"
...
pub fn run(root: &Path) -> Result<(), String> {
    ...
    fs::write(&manifest_smoke, manifest_source_smoke_java_source())
    ...
    print!("{report}");
    println!(
        "{scenarios} fetches classified as documented and dispositioned by the Rust core through the real .so"
    );
    println!(
